...
> **Version:** 1.0.0 | **Last reviewed:** 2026-06-26
> Template used by `/spec reverse` to generate a specification from existing code.
> Agent fills this template with data gathered from code analysis + entity triage.
...
> **Deprecated:** false
> **Deprecated-By:** spec-new-feature.md
> **Renamed-From:** spec-old-name.md
> **Anchor-Prefix:** [csa-prefix]
...
1. [Confirmed assumption about existing codebase structure]
2. [Confirmed assumption about target user behavior]
3. [Confirmed assumption about inherited system design patterns]
4. [Confirmed assumption about scope boundaries]

---

## Reverse Adoption Context

> This section is generated during `/spec reverse` and documents the
> code archaeology process. It may be removed when the spec matures.

### Code Archaeology
[Design decisions extracted from existing code analysis via graph_context_bundle]

### Existing Coverage Map
[Which CSA anchors and @para-doc links already exist for this module]
[Output from graph_spec_candidates — triage results]

### Retrofitting Notes
[What was preserved from existing code, what was changed,
 what conventions were inherited from sysdesign]

---

## 1. Objective

**What:** [What we're building/what existing logic does — one paragraph]
...
> Define the rules and skills required for the AI Agent to maintain this project's architecture.

**Required Project Rules (via `/para-rule`):**
- [ ] `rule-[name].md`: [Reason]

**Required Agent Skills / Sidecar Skills (via `/para-skill`):**
- [ ] `skill-[name].md`: [Required skill]
