...
const translations = {
    vi: {
        ...
        minDegree: "Bậc kết nối tối thiểu",
        highConfidence: "Chỉ hiện kết nối tin cậy (Extracted)",
        details: "Chi tiết",
        memory: "Nhật ký",
        detailsEmpty: "Chọn một nút trên biểu đồ hoặc danh sách để xem chi tiết code.",
        codeLocation: "Vị trí Code",
        openVscode: "Mở trong VSCode",
        signature: "Đặc tả Signature",
        aiSummary: "Tóm tắt Semantic AI",
        ...
        riskHigh: "Cao",
        impactAnalysis: "Phân tích Ảnh hưởng (Impact)",
        ...
        featuresGuide1Desc: "Click vào một node bất kỳ trên biểu đồ để định vị mã nguồn và xem đặc tả chữ ký (signature).",
        ...
        featuresGuide3Title: "Làm giàu ngữ nghĩa AI (Semantic)",
