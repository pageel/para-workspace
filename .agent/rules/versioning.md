...
- Current release branch: `1.3.x`.

## 2. Increment Policy

- **PATCH increments** (`1.3.1` -> `1.3.2`): Used for bug fixes, documentation updates, and small features.
- **MINOR increments** (`1.3.x` -> `1.4.0`): Used for significant new features or architectural changes.
- **MAJOR increments**: Used for breaking changes.

## 3. User Approval (CRITICAL)

- Do NOT increment the **MINOR** version (e.g., jumping from `1.3.x` to `1.4.0`) without explicit approval from the USER.
