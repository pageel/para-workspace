...
- **Governed Libraries (Skills)**: Fixed `install.sh` failing to copy nested subdirectories within libraries, effectively allowing complex items like `skills` (e.g., `para-kit`) to correctly sync to `.agents/skills/`.
