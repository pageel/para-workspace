...
| [📑 Workflow Catalog](#-catalog-workflow) | 22 governed workflows |
| [🛡️ Rule Catalog](#️-catalog-quy-tắc-rules) | 11 governance rules |
| [🏗️ Kiến trúc Rule](#️-kiến-trúc-rule--two-tier-loading--defense-in-depth) | Two-Tier loading, defense-in-depth |
| [🧩 Quản lý Tác vụ](#-quản-lý-tác-vụ-mô-hình-hybrid-3-file) | Hybrid 3-File model |
...
| **[`formatting`](./rules/formatting-tables-diagrams.md)**                          | Bảng, biểu đồ, tree listings, ASCII box art              | 🟢 Standard  |
