...
Version actuelle : **1.8.11** (Release Hardening: dirty-check et diff de templates pour install-tool, intégration des workflows de staging/scan-sec/vibecode/resource).
