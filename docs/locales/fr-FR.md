...
Version actuelle : **1.9.5** (Consolidation des modèles et publication).
Mises à jour prévues : **v1.10.0** (Plugin Hooks et extensions vibecode_session) et **v1.x.x** (Départements système).
