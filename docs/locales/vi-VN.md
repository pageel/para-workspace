...
[![Version](https://img.shields.io/badge/version-1.9.6.1-blue.svg)](../../CHANGELOG.md)
...
- [x] **Ngoại lệ Platform Tracker & Tách biệt Kế hoạch dự án** _(phát hành v1.9.0)_
- [x] **Bản mẫu Plan/Session-Plan & Bảo vệ 2 định dạng** _(phát hành v1.9.1)_
- [x] **Tối ưu hóa Tiêu chuẩn & Lộ trình** _(phát hành v1.9.2)_
